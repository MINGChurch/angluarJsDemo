 ...
 *
 * $animate.leave(kids[0]); //stagger views=0
 * $animate.leave(kids[1]); //stagger views=1
 * $animate.leave(kids[2]); //stagger views=2
 * $animate.leave(kids[3]); //stagger views=3
 * $animate.leave(kids[4]); //stagger views=4
 *
 * $timeout(function() {
 *   //stagger has reset itself
 *   $animate.leave(kids[5]); //stagger views=0
 *   $animate.leave(kids[6]); //stagger views=1
 * }, 100, false);
 * </pre>
 *
